...
def test_formulaire_sans_simulation(client, campaign, responsable):
...
def test_coupure_stricte_au_rang(client, db_session, deux_dossiers, responsable):
    login(client, "responsable@test.dz")
...
def test_plafond_billet_applique(client, db_session, deux_dossiers, responsable):
    login(client, "responsable@test.dz")
    r = client.get("/commission/budget",
...
def test_budget_invalide(client, db_session, campaign, responsable):
    login(client, "responsable@test.dz")
